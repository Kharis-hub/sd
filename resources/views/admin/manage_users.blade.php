                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Daftar Guru</h6>
                                    <p class="text-sm">Menampilkan Informasi Tentang Semua Guru</p>
                                </div>
                            ...
                            <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                    ...
                                    <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable2"
                                        autocomplete="off">
                                    <label class="btn btn-white px-3 mb-0" for="btnradiotable2">Actived</label>
                                    <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable3"
                                        autocomplete="off">
                                    <label class="btn btn-white px-3 mb-0" for="btnradiotable3">Deactivated</label>
                                </div>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Foto
                                                Profile</th>
                                            <th
                                    ...
                                    <tbody>
                                        @foreach ($guru as $g)
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('assets/img/profile/' . $g->image) }}"
                                                        class="img-fluid img-rounded img-responsive"
                                                        style="width: 100px; border-radius: 25%;"></td>
                                                <td>{{ $g->nama }}</td>
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#infoGuruModal{{ $g->id }}"><i
                                                            class="fa-solid fa-circle-info"></i></button>
                                                    <button type="button" class="btn btn-success btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#editGuruModal{{ $g->id }}"><i
                                                            class="fas fa-pen"></i></button>
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#deleteGuruModal{{ $g->id }}"><i
                ...
                <div class="col-12">
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Daftar Siswa</h6>
                                    <p class="text-sm">Menampilkan Informasi Tentang Semua Guru</p>
                                </div>
                                <div class="ms-auto d-flex">
                                    <button type="button" class="btn btn-sm btn-white me-2">
                                ...
                                <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7">Foto
                                                Profile</th>
                                            <th
                                                class="text-center text-secondary text-xs font-weight-semibold opacity-7">
                                                Nama Guru</th>
                                    ...
                                    <tbody>
                                        @foreach ($siswa as $s)
                                            <tr>
                                                <th scope="row">{{ $loop->iteration }}</th>
                                                <td><img src="{{ asset('assets/img/profile/' . $s->image) }}"
                                                        class="img-fluid img-rounded img-responsive"
                                                        style="width: 100px; border-radius: 25%;"></td>
                                                <td>{{ $s->nama }}</td>
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#infoGuruModal{{ $s->id }}"><i
                                                            class="fa-solid fa-circle-info"></i></button>
                                                    <button type="button" class="btn btn-success btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#editGuruModal{{ $s->id }}"><i
                                                            class="fas fa-pen"></i></button>
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#deleteGuruModal{{ $s->id }}"><i
                                                            class="fas fa-trash"></i></button>
                                                </td>
                                            </tr>
                                        @endforeach
